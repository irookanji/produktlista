...
## 5. Theme switcher (light / dark / device)

Follow the phone, or lock light/dark.

- `theme$`: `"light" | "dark" | "system"`
- `class="dark"` on `<html>` + Tailwind `dark:` variants
- `prefers-color-scheme` when theme is `system`
- Persist next to locale; apply before first paint to avoid a flash
